...
'''
MARTIAL_HERO_SIZE = 960/10
MARTIAL_HERO_SCALE = 0.1 # 待改
MARTIAL_HERO_DATA = [MARTIAL_HERO_SIZE, MARTIAL_HERO_SCALE]

HERO_KNIGHT_SIZE = 960/11
HERO_KNIGHT_SCALE = 0.1
HERO_KNIGHT_DATA = [HERO_KNIGHT_SIZE, HERO_KNIGHT_SCALE]

EVIL_WIZARD_SIZE = 960/8
EVIL_WIZARD_SCALE = 0.1
EVIL_WIZARD_DATA = [EVIL_WIZARD_SIZE, EVIL_WIZARD_SCALE]

MEDIEVAL_KING_SIZE = 960/8
MEDIEVAL_KING_SCALE = 0.1
MEDIEVAL_KING_DATA = [MEDIEVAL_KING_SIZE, MEDIEVAL_KING_SCALE]

MEDIEVAL_WARRIOR_SIZE = 96
MEDIEVAL_WARRIOR_SCALE = 0.1
MEDIEVAL_WARRIOR_DATA = [MEDIEVAL_WARRIOR_SIZE, MEDIEVAL_WARRIOR_SCALE]
