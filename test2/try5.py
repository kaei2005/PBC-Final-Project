...
frame_counts = [8, 11, 10, 10, 8, 10]  # Specify the number of frames for each character
...
CHARACTER_START_Y = (SCREEN_HEIGHT - CHARACTER_SIZE[1]) // 2 + 100  # 向下移动100像素
...
while running:
    ...
    if current_animation_frames is not None:
        animation_counter += 0.05  # Reduce the increment further to slow down the animation
